...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif, COUNT(i.ogrno) \n" +
            "FROM ogrenci o \n" +
            "INNER JOIN islem i \n" +
            "ON o.ogrno=i.ogrno \n" +
    ...
    String QUESTION_5 = "SELECT COUNT(ogrno) \n" +
            "FROM ogrenci";
    ...
    String QUESTION_8 = "SELECT sinif, COUNT(ad) \n" +
            "FROM ogrenci \n" +
            "GROUP BY sinif";
    @Query(value = QUESTION_8, nativeQuery = true)
    List<StudentClassCount> findStudentClassCount();

    String QUESTION_9 = "SELECT o.ad,o.soyad, COUNT(i.ogrno) \n" +
            "FROM ogrenci o \n" +
            "INNER JOIN islem i \n" +
            "ON o.ogrno=i.ogrno \n" +
